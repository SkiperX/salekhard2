...
?>
 ...
 <div class="page__b-event-info">
                            ...
                            <div class="col-md-5">
                                <div class="b-event-info__white">
                                    <div class="b-event-info__list">
										...
										<? $date = str_replace('.', '/', $arResult['PROPERTIES']['DATE']['VALUE']); ?>
                                            <div class="b-event-info__val"><?= FormatDateFromDB($date, 'DD MMMM'); ?>
                                            </div>
                                        </div>
                                        <div class="b-event-info__item">
                                            <div class="b-event-info__ico">
                ...
                <div class="b-order">
                    ...
                    <form id="mer_form" action="/local/php_interface/forms/init.php" method="POST">
					...
					<input type="hidden" name="page" value="<?= $arResult['DETAIL_PAGE_URL']; ?>" />
                        ...
                        <div class="b-order__item">
                            <div class="form-group">
                                ...
                                <div class="form-group__cont form-group__cont_ico form-group__cont_ico-left">
                                    <input required name="phone" class="form-control" type="tel"  pattern="[\+]\d{1}\s[\(]\d{3}[\)]\s\d{3}[\-]\d{2}[\-]\d{2}" minlength="18" maxlength="18" />
                                    <div class="form-group__ico">
