...
<div class="b-intro-simple__title">Поиск
                          </div>
</div>
...
<div class="search-page-search-block">
					...
					<?else:?>
	<div class="form-group__cont form-group__cont_ico form-group__cont_ico-left search-page-input">
						<input class=" form-control" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" />
				</div>
					<?endif;?>
<div class="search-page-button">
	<button class="b-order__btn" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" >Поиск</button>
					</div>
				</div>
		<noindex>
